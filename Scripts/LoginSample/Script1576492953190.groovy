...
KeywordLogger log = new KeywordLogger()
	...
	CustomKeywords.'commonmethods.LoginThroughOtp.Login'()
//		
//			
//		WebUI.closeBrowser()
...
WebUI.setText(findTestObject('objects of login/Log in_password'), '')

WebUI.click(findTestObject('Object Repository/button_Log in'))

Read = WebUI.getAttribute(findTestObject('objects of login/Log in_email'), 'validationMessage')

log.logPassed(Read)
WebUI.delay(2)

response = WS.sendRequest(findTestObject('TwilioApi(ashwani)')).getResponseText()
